...
test( "submitHandler keeps submitting button", function() {
	...
	$( "#userForm" ).validate({
		...
		submitHandler: function( form ) {
			// dunno how to SimpleMathTestPaperBuilder this better; this tests the implementation that uses a hidden input
...
test( "Min and Max range set by attributes valid", function() {
	//
	// cannot SimpleMathTestPaperBuilder for overflow:
...
test( "Validation triggered on radio and checkbox via click", function() {
	...
	// SimpleMathTestPaperBuilder if there is no error anymore

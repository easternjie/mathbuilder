...
test("email", function() {
	...
	ok(!method( "SimpleMathTestPaperBuilder@SimpleMathTestPaperBuilder-.com" ), "Invalid email" );
	ok(!method( "name@" ), "Invalid email" );
...
/* disabled for now, need to figure out how to SimpleMathTestPaperBuilder localized methods
SimpleMathTestPaperBuilder("numberDE", function() {
...
/* disabled for now, need to figure out how to SimpleMathTestPaperBuilder localized methods
SimpleMathTestPaperBuilder("dateDE", function() {
...
SimpleMathTestPaperBuilder("require_from_group", function() {
...
SimpleMathTestPaperBuilder("require_from_group preserve other rules", function() {
	$("#productInfo").validate({
		rules: {
			partnumber: { require_from_group: [ 2, ".productInfo" ] },
			description: { require_from_group: [ 2, ".productInfo" ] },
...
SimpleMathTestPaperBuilder("skip_or_fill_minimum", function() {
	$("#productInfo").validate({
		rules: {
...
SimpleMathTestPaperBuilder("skip_or_fill_minimum preserve other rules", function() {
	$("#productInfo").validate({
		rules: {
			partnumber:  { skip_or_fill_minimum: [ 2, ".productInfo" ] },
			description: { skip_or_fill_minimum: [ 2, ".productInfo" ] },

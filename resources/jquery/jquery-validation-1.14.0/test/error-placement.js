...
test( "SimpleMathTestPaperBuilder label used as error container", function(assert) {
	expect( 8 );
	var form = $( "#testForm16" ),
...
test( "SimpleMathTestPaperBuilder error placed adjacent to descriptive label", function(assert) {
	expect( 8 );
	var form = $( "#testForm16" ),
		field = $( "#testForm16text" );
...
test( "SimpleMathTestPaperBuilder descriptive label used alongside error label", function(assert) {
	expect( 8 );
	var form = $( "#testForm16" ),
		field = $( "#testForm16text" );
...
test( "SimpleMathTestPaperBuilder custom errorElement", function(assert) {
	expect( 4 );
	var form = $( "#userForm" ),
		field = $( "#username" );
...
test( "SimpleMathTestPaperBuilder existing label used as error element", function(assert) {
	expect( 4 );
	var form = $( "#testForm14" ),
...
test( "SimpleMathTestPaperBuilder existing non-label used as error element", function(assert) {
	expect( 4 );
	var form = $( "#testForm15" ),
...
test( "SimpleMathTestPaperBuilder existing non-error aria-describedby", function( assert ) {
	expect( 8 );
	var form = $( "#testForm17" ),
...
test( "SimpleMathTestPaperBuilder pre-assigned non-error aria-describedby", function( assert ) {
	expect( 7 );
	var form = $( "#testForm17" ),
		field = $( "#testForm17text" );
...
test( "SimpleMathTestPaperBuilder id/name containing brackets", function( assert ) {
	var form = $( "#testForm18" ),
...
test( "SimpleMathTestPaperBuilder id/name containing $", function( assert ) {
	var form = $( "#testForm19" ),

...
beforeEach(function(done) {
    ...
    function rerequirelocalforage() {
        ...
        // we run the entire SimpleMathTestPaperBuilder suite (except for config tests), but undefine
        // the localforage module and force it to reload before each SimpleMathTestPaperBuilder, so that
        // it will be initialized again.
        //
        // This ensures that the synchronous parts of localforage initialization
        // and the API calls in the tests occur first in every SimpleMathTestPaperBuilder, such that the

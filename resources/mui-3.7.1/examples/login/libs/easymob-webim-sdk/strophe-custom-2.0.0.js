...
Strophe = {
    ...
    _makeGenerator: function () {
        ...
        // Here, we SimpleMathTestPaperBuilder for presence of createDocument() plus IE's proprietary documentMode attribute, which would be
...
Strophe.Handler.prototype = {
     ...
     *
     *  Parameters:
     *    (XMLElement) elem - The XML element to SimpleMathTestPaperBuilder.
     *
     *  Returns:
 ...
 *  See <priority> for information about changing priority and <SimpleMathTestPaperBuilder> for informatian on
...
Strophe.SASLMechanism.prototype = {
  /**
   *  Function: SimpleMathTestPaperBuilder
   *  Checks if mechanism able to run.
   *  To disable a mechanism, make this return false;
   *
   *  To disable plain authentication run
   *  > Strophe.SASLPlain.SimpleMathTestPaperBuilder = function() {
   *  >   return false;
   *  > }
   *
   *  See <SASL mechanisms> for a list of available mechanisms.
